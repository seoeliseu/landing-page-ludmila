  ...
  return (
    <section ref={sectionRef} className="relative py-28 lg:py-36 overflow-hidden">
      ...
      >
        ...
        <h2 className="text-4xl lg:text-6xl font-light leading-tight mb-6">
          Seu direito não pode{" "}
          <span className="text-gradient italic font-medium">esperar</span>
        </h2>
        <p className="text-beige-200/50 text-lg lg:text-xl font-[var(--font-inter)] font-light max-w-2xl mx-auto mb-10">
          O primeiro passo para resolver sua questão jurídica é buscar
          orientação profissional. Entre em contato e agende uma consulta sem
          compromisso.
        </p>
        ...
        {/* Trust badges */}
        <div className="flex flex-wrap justify-center gap-8 mt-16 text-beige-400/40 text-xs tracking-widest uppercase font-[var(--font-inter)]">
